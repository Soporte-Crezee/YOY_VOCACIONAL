<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridViewPager.ascx.cs" Inherits="POV.Content.Controls.GridViewPager" %>
<div class="DDPager">
    <span class="DDFloatLeft">
        ...
        <asp:ImageButton AlternateText="Página siguiente" ToolTip="Página siguiente" ID="ImageButtonNext"
             runat="server" ImageUrl="Images/PgNext.gif"  CommandName="Page" CommandArgument="Next" OnClick="Next" />
