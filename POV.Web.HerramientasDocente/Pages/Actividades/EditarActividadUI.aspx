<%@ Page Title="" Language="C#" MasterPageFile="~/Content/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="EditarActividadUI.aspx.cs" Inherits="POV.Web.HerramientasDocente.Pages.Actividades.EditarActividadUI" %>
    ...
    <div class="bodyadaptable">
        <div class="divPrincipal col-xs-12">
            <div class="titulo_principal_superior col-xs-12">
                <asp:Label ID="lblTitulo" Text="Editar actividad" runat="server"></asp:Label>
            </div>
            <div class="divContenido col-xs-12">
                <div class="col-xs-12 col-md-6 bootresposive" style="padding: 0px 0px 0px 0px;">
                    <div class="col-xs-12 titulo_marco bootresposive">
                        <asp:Label runat="server" ID="lblSubtitulo1" Text="Información general"></asp:Label>
                    </div>
                    <div class="col-xs-12 container_busqueda_general bootresposive ui-widget-content">
                        <br />
                        <div class="col-xs-12 form-group form-horizontal bootresposive">
                            <label class="col-sm-4 control-label">Nombre</label>
                            <div class="col-sm-8">
                                <asp:TextBox runat="server" ID="txtNombreActividad" MaxLength="100" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 form-group form-horizontal bootresposive">
                            <label class="col-sm-4 control-label">Instrucciones para el estudiante</label>
                            <div class="col-sm-8">
                                <asp:TextBox runat="server" ID="txtDescripcionActividad" TextMode="MultiLine" MaxLength="500" Width="100%" Rows="3" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-md-6 bootresposive" style="padding: 0px 0px 0px 0px">
                    ...
                    <div class="col-xs-12 container_busqueda_general ui-widget-content">
                        <br />
                        <div class="col-xs-12 form-group bootresposive">
                            <label class="col-sm-4 control-label">
                                <asp:Label ID="lblGrupo" runat="server" Text="Cambiar &aacute;rea de conocimiento " CssClass="labelTalentos"></asp:Label>
                            </label>
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddlArea" runat="server" Width="90%"></asp:DropDownList>
                            </div>
                        </div>
                        <br />
                        <br />
                            ...
                            <table width="100%" border="0" cellspacing="0">
                                <tr class="tab_selector">
                                    <td id="td-subir" style="display: none;">
                                        <asp:LinkButton ID="lnkBtnAgregarcontenido" runat="server" OnClick="changeView_OnClick" CssClass="selector_view" Enabled="false">
                                    <i class="icon_36 icon_subir_contenido36"></i>Subir contenido
                                        </asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                            <asp:MultiView runat="server" ID="mtvTareas" ActiveViewIndex="1">
                                <asp:View runat="server" ID="viewGhost">
                                </asp:View>
            ...
            <div class="col-xs-12">
                <div style="text-align: right">
                    <asp:Button ID="btnCrearActividad" runat="server" Text="Guardar" OnClick="btnGuardarActividad_OnClick"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <uc1:AgregarContenidoUC runat="server" ID="AgregarContenidoUC" PaginaContenedora="EditarActividadUI" />
                        </div>
                    </div>
                </div>
            </div>
