<%@ Page Title="" Language="C#" MasterPageFile="~/Content/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="BuscarAlumnosFrasesVocacionalesUI.aspx.cs" Inherits="POV.Web.HerramientasDocente.Pages.Pruebas.BuscarAlumnosFrasesVocacionalesUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="bodyadaptable">
        <div class="panel panel-default" style="margin-top: 10px;">
            <div class="panel-heading">
                <asp:Label runat="server" ID="lblSubtitulo1" Text="Alumnos con pruebas Frases Incompletas Vocacionales contestadas"></asp:Label>
            </div>
    ...
    <div class="results" style="margin-bottom: 20px">
        <asp:UpdatePanel ID="updAlumnosSACKS" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdAlumnosFrasesVocacionales" runat="server" CssClass="table table-striped table-bordered" RowStyle-CssClass="td"
                    ...
                    OnSorting="grdAlumnosFrasesVocacionales_Sorting" OnRowDataBound="grdAlumnosFrasesVocacionales_DataBound"
                     OnPageIndexChanging="grdAlumnosFrasesVocacionales_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "AlumnoID")%>'
                                    Text="Sumario general prueba" ToolTip="Completar prueba Frases Vocacionales"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
