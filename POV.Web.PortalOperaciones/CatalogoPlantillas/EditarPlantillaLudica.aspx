<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarPlantillaLudica.aspx.cs" Inherits="POV.Web.PortalOperaciones.CatalogoPlantillas.EditarPlantillaLudica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        $(function () {
            $("#<%=pnlwork.ClientID%>").click(function (e) {
                 ...
                 var valores = $("#<%=txtpuntos.ClientID%>").val();

                if (valores != "")
                    valores += "|" + dato;
                else
                    valores = dato;
                $("#<%=txtpuntos.ClientID%>").val(valores);
         ...
         function pintar() {
            ...
            for (var index = 0; index < coords.length; index++) {
                ...
                $("#<%=pnlwork.ClientID%>").append('<div class="icon_36 dragmenow" style="background-repeat: no-repeat;height: 48px;width: 37px;background-color: transparent;background-image: url(' + im + ');position: absolute;display: inline-block;' + css + '"></div>')
    ...
    <h3 class="ui-widget-header">
        ...
        /Editar plantilla l&uacute;dica</h3>
    <div class="main_div ui-widget-content" style="padding: 5px;">
                ...
                <table>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <asp:Image ID="imgFondo" runat="server" Height="100" ImageAlign="Middle" BackColor="#ffffff" Width="60" /><br />
                            <br />
        ...
        <asp:Panel ID="plPosicionActividad" runat="server" GroupingText="Posiciones de las actividades">
            <input id="txtpuntos" type="text" style="visibility: hidden; display: none" runat="server" /><asp:TextBox ID="hiddenPosicion" runat="server" Style="visibility: hidden; display: none"></asp:TextBox>
            ...
            <div style="float: right;">
                ...
                <button type="button" id="btn-limpiar" onclick="limpiar();" class="boton">Limpiar</button><br />
            </div>
            <div style="float: left;">
                <div id="pnlwork" runat="server">
                </div>
            </div>
        </asp:Panel>
        <table>
