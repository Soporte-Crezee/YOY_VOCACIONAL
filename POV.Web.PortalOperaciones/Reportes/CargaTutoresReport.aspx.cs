...
{
    public partial class CargaTutoresReport : CatalogPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                CargaDocentesRpt report = new CargaDocentesRpt(this.EscuelaActual, this.CicloEscolarActual, this.SS_ListadoCarga, this.SS_ResultadoCarga, "Carga de padres", "Padres cargados", "Padres no cargados");
                rptVAlumnos.Report = report;
                rptVAlumnos.Report.Name = "CargaPadresRpt";
            }
            catch (Exception ex)
            {
