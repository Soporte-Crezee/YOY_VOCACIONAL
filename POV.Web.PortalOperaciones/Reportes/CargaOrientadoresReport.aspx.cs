...
{
    public partial class CargaOrientadoresReport : CatalogPage
    {
        ...
        public CargaOrientadoresReport() 
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                CargaDocentesRpt report = new CargaDocentesRpt(this.EscuelaActual, this.CicloEscolarActual, this.SS_ListadoCarga, this.SS_ResultadoCarga, "Carga de orientadores", "Orientadores cargados", "Orientadores no cargados");
