<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoExportacionTutor.aspx.cs" Inherits="POV.Web.PortalOperaciones.Reportes.ResultadoExportacionTutor" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Log exportación padres</title>
            ...
            <div class="col-xs-13">
                ...
                <div class="ui-widget-content">
                    <h3 class="ui-widget-header ui-widget-header-label" style="margin-top: 0px;">
                        <asp:HyperLink ID="lnkBack" runat="server">Volver</asp:HyperLink>/Log exportaci&oacute;n padres
                    </h3>
