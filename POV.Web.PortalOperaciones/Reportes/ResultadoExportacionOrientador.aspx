<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoExportacionOrientador.aspx.cs" Inherits="POV.Web.PortalOperaciones.Reportes.ResultadoExportacionOrientador" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Log exportación orientadores</title>
            ...
            <div class="col-xs-13">
                ...
                <div class="ui-widget-content">
                    <h3 class="ui-widget-header ui-widget-header-label" style="margin-top: 0px;">
                        <asp:HyperLink ID="lnkBack" runat="server">Volver</asp:HyperLink>/Log exportaci&oacute;n orientadores
                    </h3>
