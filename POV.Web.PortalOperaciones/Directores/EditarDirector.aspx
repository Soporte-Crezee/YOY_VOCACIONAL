<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditarDirector.aspx.cs" Inherits="POV.Web.PortalOperaciones.Directores.EditarDirector" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initPage() {
           ...
           // var ddate = new Date();
           // var minddate = new Date(ddate.getFullYear(), 0, 1);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class=" ui-widget-content" style="padding: 5px">
        <table class="tablas">
            <tr>
                <td class="td-label">
                    <asp:Label ID="lblDirectorID" runat="server" Text="ID"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDirectorID" runat="server" MaxLength="30" CssClass="whitespace"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td-label">
                ...
                <td>
                    <asp:TextBox ID="txtCurp" runat="server" MaxLength="18" CssClass="whitespace textoNombrePersona"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td-label">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFechaNacimiento" runat="server" CssClass="whitespace"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td-label">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="cbEstatus" ToolTip="Estado del director">
