<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistrarPrueba.aspx.cs" Inherits="POV.Web.PortalOperaciones.Pruebas.RegistrarPrueba" %>
        ...
        <div class="main_div ui-widget-content" style="padding: 5px;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txtInstrucciones" runat="server" TextMode="MultiLine" CssClass="required" MaxLength="1000" Width="400" Height="100"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="td-label">
                        <asp:Label ID="lblModelo" runat="server" Text="Modelo de prueba" CssClass="label"></asp:Label></td>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DDLTipoPruebaPresentacion" runat="server">
                            <asp:ListItem Text="SELECCIONE..." Value=""></asp:ListItem>
                            <asp:ListItem Text="Dinamica" Value="0"></asp:ListItem>
                            <asp:ListItem Text="Habitos de estudio" Value="4"></asp:ListItem>
                            <asp:ListItem Text="Dominós" Value="5"></asp:ListItem>
                            ...
                            <asp:ListItem Text="Estilos de Aprendizaje" Value="30"></asp:ListItem> 
                            <asp:ListItem Text="Inteligencias Multiples" Value="31"></asp:ListItem>
                            <asp:ListItem Text="inventario de intereses" Value="32"></asp:ListItem>
                            <asp:ListItem Text="inventario de Herrera y Montes" Value="33"></asp:ListItem>
                            <asp:ListItem Text="Sucesos de Vida" Value="34"></asp:ListItem>
                            <asp:ListItem Text="Prueba de colores de Luscher" Value="35"></asp:ListItem>
