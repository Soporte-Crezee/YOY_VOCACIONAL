...
{
    public partial class EditarPrueba : PageBase
    {
        ...
        protected void BtnGuardar_OnClick(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(sError))
            {
                try
                {
                    ...
                    pruebaUpdate.EstadoLiberacionPrueba = this.LastObject.EstadoLiberacionPrueba;
        ...
        {
            APrueba prueba = this.catalogoPruebaCtrl.RetrieveSimple(dctx, this.LastObject, true);
            if (prueba == null)
        ...
        private string ValidateData(AModelo modelo)
        {
            ...
            if (nombre.Length > 100 || nombre.Length < 1)
                sError += "El campo clave no debe estar vacío y no debe ser mayor a 100 caracteres\n";
