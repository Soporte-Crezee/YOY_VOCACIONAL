<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="POV.Web.PortalOperaciones.Auth.Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>YOY - OPERACIONES</title>
    ...
    <form id="form1" runat="server">
        <div id="pageContainerLogin">
            ...
            <div class="col-xs-13">
                    ...
                    <div id="cabeza" style="margin: 0px; padding: 15px;">
                        <div class="row vertical-divider" style="margin-top: 0px">
                            <div class="col-xs-12 col-sm-4 col-md-3">
                                <img alt="Logo" src="../Images/SOV_ELEMENTOS logo VOCAREER1.png" style="margin: 14px 15px 0px; padding: 0px" width="280px" class="img-responsive" />
                            </div>
                            <div class="col-xs-12 col-sm-8 col-md-9">
                                <div class="col-xs-3 col-sm-2 col-md-2 col-lg-1">
                                    <img alt="Logo" src="../Images/SOV_ELEMENTOS_portaloperaciones.png" style="margin: 35px 0px 0px 10px; padding: 0px" width="50px" class="img-responsive" />
                                </div>
                                <div class="col-xs-9 col-sm-10 col-md-10 col-lg-11">
                                    <h2 class="pull-left titulo-potal" id="tituloPortal" runat="server" style="margin-top:35px;">PORTAL OPERACIONES</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!--Content-->
                <div id="container_container_login" class="bodyadaptable col-xs-12 col-md-12 col-sm-12 col-lg-12" style="margin: 0px; padding: 0px">
                    <div id="container_login_" class="bodyadaptable container_login col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: 0px; padding: 0px">
                        ...
                        <div class="col-xs-12 col-md-10">
                            <!-- Datos -->
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-md-offset-8 col-xs-offset-6" style="top: 32px;">
                    ...
                    <div class="text-center col-xs-12" style="background-color: #242525">
                        <div class="col-xs-12 footer">
                            <div class="col-xs-4 col-md-4">
                                <p class="avisos_footer"><a href="#" target="_self">T&Eacute;RMINOS DE USO.</a></p>
                            </div>
                            <div class="col-xs-4 col-md-4">
                                <p class="avisos_footer" style="color: #0067ac;">&copy;<asp:Label ID="lblFechaAnio" runat="server"></asp:Label>, Derechos reservados Compañía. </p>
                            </div>
                            <div class="col-xs-4 col-md-4">
                                <p class="avisos_footer"><a href="#">AVISO DE PRIVACIDAD.</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
