...
{
    public partial class RegistrarTipoDocumento : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RadBtnListTipoDocumento_SelectedIndexChanged(sender, e);
            }
        }
        ...
        private void DoInsert()
        {
            ...
            if (string.IsNullOrEmpty(validateMessage))
            {
                try
                {
                    ...
                    tipoDocumentoCtrl.Insert(dctx, tipoDocumento);
                    txtRedirect.Value = "BuscarTipoDocumento.aspx";
                    ShowMessage("El Tipo de Documento se ha registrado con éxito", MessageType.Information);
                }
                catch (Exception ex)
                {
