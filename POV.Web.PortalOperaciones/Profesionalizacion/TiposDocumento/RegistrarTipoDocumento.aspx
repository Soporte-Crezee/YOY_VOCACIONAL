<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistrarTipoDocumento.aspx.cs" Inherits="POV.Web.PortalOperaciones.Profesionalizacion.TiposDocumento.RegistrarTipoDocumento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="ui-widget-header">
        ...
        /Registrar tipo de documento</h3>
    <div class="main_div ui-widget-content" style="padding: 15px">
        <table>
            ...
            <tr>
                <asp:UpdatePanel runat="server" ID="updPanelExtencion">
                    <ContentTemplate>
                        <td class="td-label">
            ...
            <tr>
                <asp:UpdatePanel runat="server" ID="updPanelMIME">
                    <ContentTemplate>
                        <td class="td-label">
            ...
            <tr>
                <asp:UpdatePanel runat="server" ID="updPanelFuente">
                    <ContentTemplate>
                        <td class="td-label">
        ...
        <input type="text" id="txtRedirect" clientidmode="Static" runat="server" style="display: none;" />
    </div>
</asp:Content>
