<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistrarSituacionAprendizaje.aspx.cs" Inherits="POV.Web.PortalOperaciones.Profesionalizacion.EjesTematicos.RegistrarSituacionAprendizaje" %>
            ...
            $("#frmMain").validate(
             {
                 rules: {
                     ...
                     '<%=txtDescripcion.UniqueID %>': { maxlength: 500 },
                     '<%=txtClasificador.UniqueID %>': { maxlength: 500 },
                     '<%=txtCompetencias.UniqueID %>': { maxlength: 800 },
                     '<%=txtAprendizajes.UniqueID %>': { maxlength: 800 }
                 },
            ...
            <tr>
                <td colspan="2">
                    <div class="DDFloatRight">
                        ...
                        <asp:HyperLink ID="HpLnkCancelar" Text="Cancelar" runat="server" NavigateUrl="ConfigurarSituacionesAprendizaje.aspx"
