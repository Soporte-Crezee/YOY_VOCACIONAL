...
$(function () {
    applyButtonStyle();
    $.get('../Scripts/tmpl/reactivos.tmpl.htm', function (templates) {
...
function applyButtonStyle() {
    $(".boton").button();
    $(".boton_add").button({ icons: {
        primary: "ui-icon-circle-plus"
    }
    });
    $(".boton_icon_add").button({ icons: {
        primary: "ui-icon-circle-plus"
    },
        text: false
    });
    $(".boton_delete").button({ icons: {
        primary: "ui-icon-minus"
    },
        text: false
    });
    $(".boton_delete_text").button({ icons: {
        primary: "ui-icon-minus"
    }
    });
}
...
function eliminarEditPregunta(id) {
    ...
    apiMessages.CreateQuestionMessage(message, function () {
        ...
        eliminarPregunta(id);
        //reactivoapi.DeletePregunta({ success: function (result) { processResponseDeletePregunta(result); } }, dataString);
...
function eliminarEditOpcion(id, number) {
    ...
    apiMessages.CreateQuestionMessage(message, function () {
        ...
        //reactivoapi.DeleteOpcionPregunta({ success: function (result) { processResponseDeleteOpcionPregunta(result); } }, dataString);
