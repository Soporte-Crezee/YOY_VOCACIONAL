<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AsignarPruebaPivote.aspx.cs" Inherits="POV.Web.PortalOperaciones.Contratos.Recursos.AsignarPruebaPivote" %>
    ...
    <div class="ui-widget-content" style="padding: 5px;">
        ...
        <asp:Panel ID="pnlPruebasAsignar" runat="server" GroupingText="Pruebas disponibles">
         <div class="ui-widget-content" style="padding: 15px">
            <table class="conPadding alignDerecha">
                <tr>
                    <td class="td-label">
            ...
            <asp:UpdatePanel ID="updPruebas" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="grdPruebasPivote" runat="server" CssClass="DDGridView" RowStyle-CssClass="td"
                        HeaderStyle-CssClass="th" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"
                        Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="true" OnRowCommand="grdPruebasPivote_RowCommand">
                        <Columns>
