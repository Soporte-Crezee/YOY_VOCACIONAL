<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarReactivoOpcion.aspx.cs" Inherits="POV.Web.PortalOperaciones.CatalogoReactivos.Dinamico.EditarReactivoOpcion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function gotoOpNew(op) {
            setTimeout(function () {
                window.location = "#" + op;
                var textarea = 0;
                $("textarea.texto-opcion").each(function (i) {
                    textarea++;
                });
                $("textarea.texto-opcion").each(function (i) {
                    if ((textarea - 1) == i) {
        ...
        function ValidateFields() {
            ...
            var inputImagenPreguntaAnterior = $("#<%= hdnImagenPreguntaAnterior.ClientID %>").val();
            if (tipoPresentacion != 1) {
                if (inputImagenPreguntaAnterior == '')
            ...
            if (tipoPresentacionOpcion == 0) {
                ...
                $('input[name$="hdnImagen"]').each(function (index) {
                    ...
                    var indice = id.indexOf("_" + index);

                    var idAnterior = id.substring(0, indice) + "OpcAnterior_" + index;
                    if ($("#" + idAnterior).val() == '')
                        $(this).addClass("required");
                });
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3 class="ui-widget-header ui-widget-header-label">
        ...
        reactivo opci&oacute;n m&uacute;ltiple</h3>
    <div class="main_div ui-widget-content table-responsive" style="padding: 15px;">
        <table>
            <tr>
                <td class="td-label">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="Label1" runat="server" CssClass="label" Text="Pregunta texto abierto" Enabled="False"></asp:Label>
                    <asp:CheckBox ID="cbPreguntaAbierta" runat="server" AutoPostBack="True" TextAlign="Left" Enabled="False" />
                </td>
                <td></td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlModelo" runat="server" OnSelectedIndexChanged="ddlModelo_SelectedIndexChanged"
                        AutoPostBack="true" CssClass="required" Enabled="false" Width="300">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPregunta" runat="server" TextMode="MultiLine" Columns="40" Rows="5" CssClass="required"></asp:TextBox>
                </td>
                <td></td>
            </tr>
            ...
            <div id="divReactivoOpcionMultiple" runat="server">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <tr>
                            <td>
                                <asp:Label ID="lblImagenPreguntaAnterior" runat="server" Text="Imagen anterior" CssClass="label"></asp:Label></td>
                            <td>

                                <asp:Image ID="imgPreguntaAnterior" runat="server" Width="100" Height="100" ImageAlign="Middle" BackColor="#ffffff" /><br />
                                <br />
                                <asp:Button ID="btnEliminarPreguntaAnterior" runat="server" CssClass="btn-cancel" Text="Eliminar imagen" OnClick="btnEliminarImgPreguntaAnterior_OnClick" />
                                <asp:HiddenField ID="hdnImagenPreguntaEliminada" runat="server" />
                                <asp:HiddenField ID="hdnImagenPreguntaAnterior" runat="server" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlPresentacionOpc" runat="server">
                            ...
                            <asp:ListItem Text="Imagen" Value="1"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                </tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding: 0px 0px 0px 40px">
                                                <div class="checkbox">
                                                    <asp:CheckBox ID="chkEsCorrecta" Checked="true" runat="server" Text="¿Es Correcta?" Visible="true" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPuntaje" runat="server" CssClass="number" MaxLength="14"></asp:TextBox>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lblImagenOpcAnterior" runat="server" Text="Imagen opci&oacute;n anterior" CssClass="label"></asp:Label></td>
                                                    <td>

                                                        <asp:Image ID="imgOpcAnterior" runat="server" Width="100" Height="100" ImageAlign="Middle" BackColor="#ffffff" /><br />
                                                        <br />
                                                        <asp:Button ID="btnEliminarOpcAnterior" runat="server" CssClass="btn-cancel" Text="Eliminar imagen" CommandArgument="deleteImagenOpcAnterior" CommandName="deleteImagenOpcAnterior" />
                                                        <asp:HiddenField ID="hdnImagenOpcEliminada" runat="server" Value="false" />
                                                        <asp:HiddenField ID="hdnImagenOpcAnterior" runat="server" />
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
