<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarModeloPrueba.aspx.cs" Inherits="POV.Web.PortalOperaciones.CatalogoModeloPrueba.RegistrarModeloPrueba" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="ui-widget-header ui-widget-header-label">
        <asp:LinkButton ID="lnkBack" runat="server" OnClick="BtnCancelar_OnClick" OnClientClick="CancelValidate()">Volver</asp:LinkButton>/Registrar modelo de prueba
    </h3>
    <div class="main_div ui-widget-content" style="padding: 5px;">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDLMetodoCalificacion" runat="server">
                ...
                <ContentTemplate>
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtDescripcionPropiedad" runat="server" MaxLength="500" Height="50px"></asp:TextBox>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
