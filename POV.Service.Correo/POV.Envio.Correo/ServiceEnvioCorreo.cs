...
{
    public partial class ServiceEnvioCorreo : ServiceBase
    {
        ...
        private void tmServicio_Elapsed(object sender, ElapsedEventArgs e) 
        {
            try
            {
                System.Diagnostics.EventLog.WriteEntry("ServicioEnvioCorreosYOY", "Servicio Iniciado");
                Action();
                System.Diagnostics.EventLog.WriteEntry("ServicioEnvioCorreosYOY", "Servicio Finalizado");
            }
            catch (Exception ex)
            {
                System.Diagnostics.EventLog.WriteEntry("ServicioEnvioCorreosYOY", "Ocurrió el siguiente error: " + ex.Message);
            }
        }
        ...
        public List<KeyValuePair<Usuario, ALicencia>> getDataUsuarioLicenciaToList() 
        {
        ...
        public void enviarCorreo(Usuario usuario, ALicencia licencia, string password)
        {
            #region Variables
