...
{
    /// <summary>
    /// Clase especifica de la validacion del metodo de calificiacion por porcentaje de aciertos
    /// </summary>
    public class ValidadorPorcentaje : IValidadorReactivo
    {
        /// <summary>
        ...
        public RespuestaValidacionReactivo Validar(Reactivo reactivo)
        {
            ...
            if ((reactivo.Caracteristicas as CaracteristicasModeloGenerico).Modelo.MetodoCalificacion != EMetodoCalificacion.PORCENTAJE)
                throw new ArgumentException("ValidadorPuntos: el método de calificación debe ser por porcentaje de aciertos");
