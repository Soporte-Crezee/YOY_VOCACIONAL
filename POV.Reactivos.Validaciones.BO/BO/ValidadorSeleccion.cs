...
{
    /// <summary>
    /// Clase especifica de la validacion del metodo de calificiacion por seleccion de clasificadores
    /// </summary>
    public class ValidadorSeleccion : IValidadorReactivo
    {
        /// <summary>
        ...
        public RespuestaValidacionReactivo Validar(Reactivo reactivo)
        {
            ...
            if ((reactivo.Caracteristicas as CaracteristicasModeloGenerico).Modelo.MetodoCalificacion != EMetodoCalificacion.SELECCION)
                throw new ArgumentException("ValidadorPuntos: el método de calificación debe ser por selección");
