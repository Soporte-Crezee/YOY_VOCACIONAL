<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NuevoEvento.aspx.cs" Inherits="POV.Web.PortalUniversidad.Eventos.NuevoEvento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ol class="breadcrumb">
      ...
      <li style="font-size:30px !important;">Registrar evento</li>
    </ol>
    ...
    <div class="text-center">
        <div class="opciones_formulario">
            ...
            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" UseSubmitBehavior="false" TabIndex="6" class="btn btn-cancel btn-md" OnClick="btnCancelar_Click" />
        </div>
    </div>
    <div class="">
            <script type="text/javascript">
                ...
                var loadEventsCalendars=function () {
                    ...
                    $('#<%=txtFechaInicio.ClientID %>').datetimepicker({
                        format: 'DD/MM/YYYY',
                        locale: 'es',
                        minDate: moment().date(mymoment.date()).month(mymoment.month()).year(mymoment.year())
                        //defaultDate: mymoment
