<%@ Page Title="" Language="C#" MasterPageFile="~/Errores.Master" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="POV.Web.PortalUniversidad.Error" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="page col-xs-12">
        <div class="page">
            <div class="pageError">
                <div class="">
                    <img alt="404" src="~/Images/SOV_imgError.png" class="imgError img-responsive" runat="server" />
                </div>
