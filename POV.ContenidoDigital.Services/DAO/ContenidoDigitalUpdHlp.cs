...
{
    /// <summary>
    /// Actualiza un registro de ContenidoDigital en la BD
    /// </summary>
    internal class ContenidoDigitalUpdHlp
    {
        /// <summary>
        /// Actualiza de manera optimista un registro de ContenidoDigitalUpdHlp en la base de datos.
        /// </summary>
        /// <param name="dctx">El DataContext que proveerá acceso a la base de datos</param>
        /// <param name="contenidoDigitalUpdHlp">ContenidoDigitalUpdHlp que tiene los datos nuevos</param>
        /// <param name="anterior">ContenidoDigitalUpdHlp que tiene los datos anteriores</param>
        public void Action(IDataContext dctx, ContenidoDigital contenidoDigital, ContenidoDigital anterior)
        {
            ...
            if (anterior == null)
                sError += ", Anterior";
            if (sError.Length > 0)
                throw new Exception("ContenidoDigitalUpdHlp: Los siguientes campos no pueden ser vacios " + sError.Substring(2));
            ...
            if (dctx == null)
                throw new StandardException(MessageType.Error, "", "DataContext no puede ser nulo", "POV.ContenidosDigital.DAO",
                   "ContenidoDigitalUpdHlp", "Action", null, null);
            ...
            {
                throw new StandardException(MessageType.Error, "", "ContenidoDigitalUpdHlpUpdHl: Hubo un error al conectarse a la base de datos", "POV.ContenidosDigital.DAO",
                   "ContenidoDigitalUpdHlp", "Action", null, null);
            }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("ContenidoDigitalUpdHlp: Hubo  un Error al Actualizar el Registro . " + exmsg);
            }
            finally
            {
                try { dctx.CloseConnection(myFirm); }
            ...
            if (iRes < 1)
                throw new Exception("ContenidoDigitalUpdHlp: Hubo  un Error al Actualizar el Registro .");
        }
    }
}
