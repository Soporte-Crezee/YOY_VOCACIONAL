...
namespace GP.SocialEngine.DAO { 
   /// <summary>
   /// Consultar Registros de SocialHub de Reactivo en la base de datos
   /// </summary>
   public class SocialHubReactivoRetHlp { 
      /// <summary>
      ...
      if (socialHub.SocialProfile == null) {
         socialHub.SocialProfile = new Reactivo();
      }
      ...
      throw new StandardException(MessageType.Error, "", "DataContext no puede ser nulo", "GP.SocialEngine.DAO", 
         "SocialHubReactivoRetHlp", "Action", null, null);
      ...
      throw new StandardException(MessageType.Error, "", "SocialHubRetHlp: No se pudo conectar a la base de datos", "GP.SocialEngine.DAO", 
         ...
         if (socialHub.SocialProfileID != null){
            s_VarWHERE.Append(" AND ReactivoID= @socialHub_SocialProfileID ");
            sqlParam = sqlCmd.CreateParameter();
