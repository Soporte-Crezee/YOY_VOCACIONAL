<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarPassword.aspx.cs" Inherits="POV.Web.PortalSocial.Auth.RecuperarPassword" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>YOY - RECUPERAR PASSWORD</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <!--Content-->
        <div id="container_login_" runat="server" class="container-fluid">
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-group" id="paso2Correo" style="display: none">
                                ...
                                <asp:TextBox ID="txtCorreo" runat="server" TextMode="Email" MaxLength="100" CssClass="form-control"></asp:TextBox>
