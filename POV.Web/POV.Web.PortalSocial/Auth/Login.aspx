<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="POV.Web.PortalSocial.Auth.Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>YOY - INICIO</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <div class="navbar navbar-default navbar-static-top">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center" id="headerLogin">
                    ...
                    <div class="col-xs-3 col-sm-2 col-md-1 col-lg-1">
                        <asp:Image runat="server" ID="imgIconoPortal" ImageUrl="~/Images/" AlternateText="Logo" Style="margin: 20px 0px 0px 10px; padding: 0px" Width="50px" />
                    </div>
        ...
        <%--</div>
        <div class="row">--%>
            <div id="divContainer" runat="server" class="container-fluid">
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer text-center">
                            ...
                            <p>
                                <asp:LinkButton runat="server" ID="btnRegistrar" TabIndex="9" Text="REGÍSTRATE AHORA" Width="190px" CssClass="btn-entrar btn-md btn-block" OnClick="btnRegistrar_Click"></asp:LinkButton>
                            </p>
                        </div>
                    </div>
                </div>
