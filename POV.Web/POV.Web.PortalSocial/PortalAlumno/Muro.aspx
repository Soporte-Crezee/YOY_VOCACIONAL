<%@ Page Title="YOY - MURO" Language="C#" MasterPageFile="~/PortalAlumno/PortalAlumno.master"
    AutoEventWireup="true" CodeBehind="Muro.aspx.cs" Inherits="POV.Web.PortalSocial.PortalAlumno.Muro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
    <div class="bodyadaptable">
        <!-- cabecera informacion muro -->
        <div id="info_perfil" class="col-xs-12">
            <h2 class="tBienvenida">Apuntes de
        ...
        <div class="col-xs-12">
            ...
            <div id="panel_insert_pub" class="ui-corner-all ui-widget-content">
                <textarea id="txtPublicacion" rows="3" class="input_textarea" placeholder="Escribe tu publicaci&oacute;n"></textarea>
                <div class="">
                    <input type="button" value="Publicar" id="btnShare" class="btn-green" />
                </div>
            </div>
        ...
        <div id="dialog-people-likes" title="">
