...
{
    public partial class ReporteAlumnoResultadoInventariodeIntereses : System.Web.UI.Page
    {
        ...
        private Dictionary<string, string> SS_RespuestaInvInt
        {
        ...
        public ReporteAlumnoResultadoInventariodeIntereses()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SS_RespuestaInvInt = null;
                    SS_AlumnoCarga = null;
                    SS_UsuarioCarga = null;
                    SS_FechaFin = string.Empty;
                    CargarDatos();
                    if (SS_AlumnoCarga == null || SS_UsuarioCarga == null || SS_RespuestaInvInt == null || SS_FechaFin == string.Empty)
                    {
                        redirector.GoToHomePage(false);
                    }

                    ResultadoPruebaInventariodeInteresesRpt report = new ResultadoPruebaInventariodeInteresesRpt(this.SS_AlumnoCarga, this.SS_UsuarioCarga, SS_RespuestaInvInt, this.SS_FechaFin);
        ...
        private void CargarDatos()
        {
            ...
            tipoPresentacionPruebas.Add(ETipoPruebaPresentacion.InventarioDeIntereses);
            ...
            foreach (var prueba in respuestaAlumno)
            {
                ...
                if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.InventarioDeIntereses)
                {
                    ...
                    sumaCalificacionesInventario = resultadoPruebasOrientacionVocacionalCtrl.RetrieveResultadoPruebaInventariodeIntereses(dctx, registro, alumno);
                    ...
                    SS_RespuestaInvInt = sumaCalificacionesInventario;
                }
            }
