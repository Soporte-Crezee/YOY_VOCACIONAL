<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAlumnoResultadoInventarioHerrera.aspx.cs" Inherits="POV.Web.PortalSocial.PortalAlumno.Reportes.ReporteAlumnoResultadoInventarioHerrera" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div id="viewer" class="text-center table-responsive">
                <dx:reportviewer id="rptVAlumnos" runat="server"></dx:reportviewer>
            </div>
        </div>
        <div class="clear">
        </div>
