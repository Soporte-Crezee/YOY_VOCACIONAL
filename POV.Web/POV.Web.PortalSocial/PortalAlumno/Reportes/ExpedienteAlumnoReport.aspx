<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpedienteAlumnoReport.aspx.cs" Inherits="POV.Web.PortalSocial.PortalAlumno.Reportes.ExpedienteAlumnoReport" %>
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <div class="col-xs-10 col-sm-10 col-md-10">
                                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2">
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/SOV_ELEMENTOS_portalestudiante.png" Style="margin: 12px 0px 0px 20px; padding: 0px" Width="50px" class="img-responsive" />
                                        </div>
