...
namespace POV.Web.PortalSocial.PortalAlumno.Reportes
{
    public partial class ReporteAlumnoResultadoBullying : System.Web.UI.Page
    {
        ...
        private void CargarDatos()
        {
            ...
            #region Pruebas
            // Pruebas realizadas            
            List<RespuestaAlumno> respuestaAlumno = respuestaAlumnoCtrl.RetrieveRespuestaAlumno(dctx, alumnoSession, presentacionPrueba, EEstadoPrueba.CERRADA).Distinct().ToList();
