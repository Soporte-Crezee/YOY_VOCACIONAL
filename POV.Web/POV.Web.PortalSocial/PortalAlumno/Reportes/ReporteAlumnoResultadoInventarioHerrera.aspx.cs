...
{
    public partial class ReporteAlumnoResultadoInventarioHerrera: System.Web.UI.Page
    {
        ...
        private Dictionary<string, string> SS_RespuestaInvHerr
        {
            get { return (Dictionary<string, string>)this.Session["RespuestaInventarioHerrera"]; }
            set { this.Session["RespuestaInventarioHerrera"] = value; }
        }
        ...
        public ReporteAlumnoResultadoInventarioHerrera()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SS_RespuestaInvHerr = null;
                    SS_AlumnoCarga = null;
                    SS_UsuarioCarga = null;
                    SS_FechaFin = string.Empty;
                    CargarDatos();
                    if (SS_AlumnoCarga == null || SS_UsuarioCarga == null || SS_RespuestaInvHerr == null || SS_FechaFin == string.Empty)
                    {
                        redirector.GoToHomePage(false);
                    }

                    ResultadoPruebaInventarioHerrerarpt report = new ResultadoPruebaInventarioHerrerarpt(this.SS_AlumnoCarga, this.SS_UsuarioCarga, SS_RespuestaInvHerr, this.SS_FechaFin);
        ...
        private void CargarDatos()
        {
            ...
            tipoPresentacionPruebas.Add(ETipoPruebaPresentacion.InventarioHerreraMontes);
            ...
            // Obtener pruebas
            Dictionary<string, string> sumaCalificacionesInventario = new Dictionary<string, string>();
            foreach (var prueba in respuestaAlumno)
            {
                ...
                if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.InventarioHerreraMontes)
                {
                    ...
                    sumaCalificacionesInventario = resultadoPruebasOrientacionVocacionalCtrl.RetrieveResultadoPruebaInventarioHerrrera(dctx, registro, alumno);
                    ...
                    SS_RespuestaInvHerr = sumaCalificacionesInventario;
                }
            }
