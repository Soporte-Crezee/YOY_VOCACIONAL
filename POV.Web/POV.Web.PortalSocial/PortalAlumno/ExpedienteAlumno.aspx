<%@ Page Title="YOY - ESTUDIANTE" Language="C#" MasterPageFile="~/PortalAlumno/PortalAlumno.master" AutoEventWireup="true" CodeBehind="ExpedienteAlumno.aspx.cs" Inherits="POV.Web.PortalSocial.PortalAlumno.ExpedienteAlumno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
    ...
    <div class="panel panel-default">
        <div id="info_alumno" class="panel-heading">
            <div id="encabezadoexpediente">
            ...
            <div>
                <ul class="nav nav-tabs" role="tablist" id="tabs">
                    <li role="presentation" class="active">
                        <a href="#infoPersonal" aria-controls="infoPersonal" role="tab" data-toogle="tab" style="color: #337ab7 !important;">Informaci&oacute;n personal</a>
                    </li>
                    <li role="presentation">
                        <a href="#historialServicios" aria-controls="historialServicios" role="tab" data-toogle="tab" style="color: #337ab7 !important;">Historial de servicios</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="form-horizontal" style="padding-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" style="margin-bottom: 5px;">
                                <asp:DropDownList ID="ddlEstado" CssClass="form-control" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            ...
                            <div class="col-sm-4" style="margin-bottom: 5px;">
                                <asp:DropDownList ID="ddlPais" CssClass="form-control" runat="server" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddlPais_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                            <!-- B1 Nombre -->
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtNombre" MaxLength="180" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtEscuela" MaxLength="250" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <!-- B5 Telefono de Casa -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtEmail" MaxLength="100" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                <h3>
                                    <label class="">&Aacute;reas de conocimiento</label>
                                </h3>
                            </div>
                    ...
                    <div class="form-horizontal" style="padding-top: 20px;">
                        <div class="form-group">
                            ...
                            <div class="table-responsive col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                                <asp:GridView AutoGenerateColumns="false" runat="server" ID="gvIntereses" CssClass="table table-bordered table-striped"
                                    RowStyle-CssClass="td" HeaderStyle-CssClass="th">
                                    <Columns>
                                        <asp:BoundField HeaderText="Mis intereses" DataField="NombreInteres">
                                            <HeaderStyle Width="260px" HorizontalAlign="Left" />
                                            <ItemStyle Width="260px" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                    </Columns>
                       ...
                       <%-- Tabla de la prueba de habitos de estudio --%>
                        <div class="form-group" visible="false" runat="server" id="divTablaResultados">
                            <div class="text-center">
                                <h2>Resultado de pruebas realizadas</h2>
                            </div>
                                            ...
                                            <div class="">
                                                <table class="table" style="text-align:center;">
                                                    ...
                                                    <tr class="tab">
                                                        ...
                                                        <td class="tabtr"><asp:Label ID="lblRavenpDirectaA" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpDirectaB" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpDirectaC" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpDirectaD" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpDirectaE" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenTotal" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" style="">
                                                            <asp:Label ID="Label30" runat="server" Style="font-weight: bolder;" Text="Puntuación Esperada"> </asp:Label>
                                                        </td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpEsperadaA" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpEsperadaB" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpEsperadaC" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpEsperadaD" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenpEsperadaE" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" style="">
                                                            <asp:Label ID="Label69" runat="server" Style="font-weight: bolder;" Text="Discrepancia"> </asp:Label>
                                                        </td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenDiscrepanciaA" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenDiscrepanciaB" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenDiscrepanciaC" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenDiscrepanciaD" runat="server"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label ID="lblRavenDiscrepanciaE" runat="server"></asp:Label></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="">
                                            ...
                                            <div class="">
                                             ...
                                             <div class="">
                                                <table class="table" style="text-align:center;">
                                                    ...
                                                    <tr class="tab">
                                                        <td class="tabtr" style="font-weight:bolder;"><asp:Label ID="Label32" runat="server" Text="Puntaje Escalar"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label runat="server" ID="lblRavenPuntaje"></asp:Label></td>
                                                        <td class="tabtr" style="font-weight:bolder;"><asp:Label ID="Label34" runat="server" Text="Percentil"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label runat="server" ID="lblRavenPercentil"></asp:Label></td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" style="font-weight:bolder;"><asp:Label ID="Label37" runat="server" Text="Discrepancia (SI/NO)"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label runat="server" ID="lblRavenDiscrepancia"></asp:Label></td>
                                                        <td class="tabtr" style="font-weight:bolder;"><asp:Label ID="Label62" runat="server" Text="Rango"></asp:Label></td>
                                                        <td class="tabtr"><asp:Label runat="server" ID="lblRavenRango"></asp:Label></td>
                                                    </tr>
                                                    <tr class="tab">                                                        
                                                        <td class="tabtr" colspan="4">
                                                            <asp:Label ID="Label38" runat="server" Text="Diagnóstico" Style="font-weight: bolder;"></asp:Label>
                                                        </td>                                                        
                                                    </tr>
                                                    <tr class="tab">                                                        
                                                        <td class="tabtr" colspan="4">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr class="tab">
                                                        <td id="Td45" class="tabtr" runat="server" colspan="4" style="text-align: center; background-color: #f1f1f1;">
                                                            <asp:Label runat="server" ID="Label41" Text="NOTA: La tabla que aparece a continuación, menciona únicamente algunas ocupaciones de tipo profesional y unas pocas de índole semiprofesional."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr class="tab">
                        ...
                        <%-- Tabla de la prueba de Frases Vocacionales  --%>
                                        ...
                                        <div class="panel-body" style="padding: 0px !important;">
                                            <div class="">
                                                <table class="table">
                                                    <tr class="tab">
                                                        <td class="tabtr" colspan="4" style="background-color: #f1f1f1; text-align: center;">
                                                            <asp:Label ID="Label42" runat="server" Text="Interpretaci&oacute;n de resultados"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" colspan="4" style="background-color: #f1f1f1;">
                                                            <asp:Label ID="Label45" runat="server" Text="Organización de personalidad y conducta de elección"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" colspan="4">
                                                ...
                                                <table class="table">
                                                    <tr class="tab">
                                                        <td class="tabtr" style="background-color: #f1f1f1; text-align: center;" colspan="2">
                                                            <asp:Label ID="Label49" runat="server" Style="font-weight: bolder;" Text="VALORES"></asp:Label>
                                                        </td>
                                                        <td class="tabtr" style="background-color: #f1f1f1; text-align: center;" colspan="2">
                                                            <asp:Label ID="Label54" runat="server" Style="font-weight: bolder;" Text="INTERESES"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr class="tab">
                                                        <td class="tabtr" style="text-align: center;">
                                                            <asp:Label ID="Label55" runat="server" Style="font-weight: bolder;" Text="Moral"></asp:Label>
                                                        </td>
                                                        <td class="tabtr">
                                                    ...
                                                    <tr class="tab">
                                                        <td class="tabtr" style="text-align: center;">
                                                            <asp:Label ID="Label63" runat="server" Style="font-weight: bolder;" Text="Legalidad"></asp:Label>
                                                        </td>
                                                        <td class="tabtr">
                                                            <asp:Label ID="lblZavicLegalidad" runat="server"></asp:Label>
                                                        </td>
                                                        <td class="tabtr">
                                                            <asp:Label ID="Label64" runat="server" Style="font-weight: bolder;" Text="Político"></asp:Label>
                                                        </td>
                                                        <td class="tabtr">
                                                    ...
                                                    <tr class="tab">
                                                        <td class="tabtr" style="text-align: center;">
                                                            <asp:Label ID="Label65" runat="server" Style="font-weight: bolder;" Text="Indiferencia"></asp:Label>
                                                        </td>
                                                        <td class="tabtr">
