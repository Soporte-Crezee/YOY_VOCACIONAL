function suscribirse(reactivoID) {
    if (reactivoID != null && reactivoID != '') {
        ...
        api.Join({ success: function (result) { processResultSuscribir(result); myApiBlockUI.unblockContainer(); } }, dataString);
...
function processResultSuscribir(data) {
    if (data.d.success == true) {
        ...
        $(hdnmessageinputid).val("Este ejercicio de práctica se ha incluido en tu mochila.");
