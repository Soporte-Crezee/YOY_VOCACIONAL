...
function showPublicacion(data) {
    ...
    }).prependTo("#DudasStream");
    $("#txtPublicacion").val("");
    $("div#DudasStream div:first").fadeIn(100);
    $("#more").html('<a class="link_blue" onclick="javascript:LoadDudas();" >Mostrar m&aacute;s publicaciones</a>');
    ChangeBtnDelete();
    ChangeBtnAbuso();
...
function getFilesUrl() {
    var randomnumber = 3;// Math.floor(Math.random() * 10000)
