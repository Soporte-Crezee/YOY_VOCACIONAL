<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master" AutoEventWireup="true" CodeBehind="BuscarAlumnosHabitosUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosHabitosUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
        <div class="panel panel-default">
            <div class="panel-heading">
                Estudiantes con pruebas H&aacute;bitos de estudio contestadas
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosHabitos" runat="server">
                <ContentTemplate>
                    <div class="table-responsive">
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosHabitos" CssClass="table table-bordered table-striped"
                            RowStyle-CssClass="td" HeaderStyle-CssClass="th" AllowPaging="True"
                            Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="True" OnRowCommand="grdAlumnosHabitos_RowCommand"
                            OnSorting="grdAlumnosHabitos_Sorting" OnRowDataBound="grdAlumnosHabitos_DataBound" OnPageIndexChanging="grdAlumnosHabitos_PageIndexChanging">
