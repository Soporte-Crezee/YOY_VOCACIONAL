<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master" AutoEventWireup="true" CodeBehind="BuscarAlumnosCleaverUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosCleaverUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">         
        <div class="panel panel-default">
            <div class="panel-heading">                
                Estudiantes con pruebas Cleaver contestadas
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosCleaver" runat="server">
                <ContentTemplate>
                    <div style="padding-top: 10px" class="table-responsive">
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosCleaver" CssClass="table table-bordered table-striped"
                            RowStyle-CssClass="td" HeaderStyle-CssClass="th" AllowPaging="True"
                            Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="True" OnRowCommand="grdAlumnosCleaver_RowCommand"
                            OnSorting="grdAlumnosCleaver_Sorting" OnRowDataBound="grdAlumnosCleaver_DataBound" OnPageIndexChanging="grdAlumnosCleaver_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#Eval( "AlumnoID")%>'
                                             Width="25px" Height="25px" ImageUrl="~/Images/icons/VOCAREER_buscar.png" ToolTip="Completar prueba Cleaver"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
