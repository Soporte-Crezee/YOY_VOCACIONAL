<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master" AutoEventWireup="true" CodeBehind="BuscarAlumnosDominosUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosDominosUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">   
       <div class="panel panel-default">
            <div class="panel-heading">
                Estudiantes con pruebas Domin&oacute; contestadas
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosDominos" runat="server">
                <ContentTemplate>
                    <div style="padding-top: 10px" class="table-responsive">                    
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosDominos" CssClass="table table-bordered table-striped"
                            RowStyle-CssClass="td" HeaderStyle-CssClass="th" AllowPaging="True"
                            Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="True" OnRowCommand="grdAlumnosDominos_RowCommand"
                            OnSorting="grdAlumnosDominos_Sorting" OnRowDataBound="grdAlumnosDominos_DataBound" OnPageIndexChanging="grdAlumnosDominos_PageIndexChanging">
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#Eval( "AlumnoID")%>'
                                            Width="25px" Height="25px" ImageUrl="~/Images/icons/VOCAREER_buscar.png" ToolTip="Completar prueba Dominós"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
