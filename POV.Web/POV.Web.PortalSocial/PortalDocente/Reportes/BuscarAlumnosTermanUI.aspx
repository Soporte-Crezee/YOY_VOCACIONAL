<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master" AutoEventWireup="true" CodeBehind="BuscarAlumnosTermanUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosTermanUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
   <div class="panel panel-default">
            <div class="panel-heading">         
                Estudiantes con pruebas Terman Merrill contestadas
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosTerman" runat="server">
                <ContentTemplate>
                    <div style="padding-top: 10px" class="table-responsive">                    
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosTerman" CssClass="table table-bordered table-striped"
                            RowStyle-CssClass="td" HeaderStyle-CssClass="th" AllowPaging="True"
                            Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="True" OnRowCommand="grdAlumnosTerman_RowCommand"
                            OnSorting="grdAlumnosTerman_Sorting" OnRowDataBound="grdAlumnosTerman_DataBound" OnPageIndexChanging="grdAlumnosTerman_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#Eval("AlumnoID")%>'
                                            Width="25px" Height="25px" ImageUrl="~/Images/icons/VOCAREER_buscar.png" ToolTip="Completar prueba Terman Merrill"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
