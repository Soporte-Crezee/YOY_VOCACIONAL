<%@ Page Title="YOY - ORIENTADOR" MasterPageFile="~/PortalDocente/PortalDocente.master" Language="C#" AutoEventWireup="true" CodeBehind="BuscarAlumnosSacksUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosSacksUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">    
        <div class="panel panel-default">
            <div class="panel-heading">         
                Estudiantes con pruebas Sacks contestada
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosSacks" runat="server">
                <ContentTemplate>
                    <div class="table-responsive">
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosSacks" CssClass="table table-bordered table-striped"
                            ...
                            OnSorting="grdAlumnosSacks_Sorting" OnRowDataBound="grdAlumnosSacks_RowDataBound" OnPageIndexChanging="grdAlumnosSacks_PageIndexChanging">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#Eval("AlumnoID") %>'
                                            Width="25px" Height="25px" ImageUrl="~/Images/icons/VOCAREER_buscar.png" ToolTip="Completar prueba Sacks"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
