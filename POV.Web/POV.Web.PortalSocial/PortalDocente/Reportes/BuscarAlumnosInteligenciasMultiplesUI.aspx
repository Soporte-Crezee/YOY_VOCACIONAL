<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master" AutoEventWireup="true" CodeBehind="BuscarAlumnosInteligenciasMultiplesUI.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Reportes.BuscarAlumnosInteligenciasMultiplesUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
        <div class="panel panel-default">
            <div class="panel-heading">
                Estudiantes con pruebas Inteligencias M&uacute;ltiples contestadas
            </div>
            ...
            <asp:UpdatePanel ID="updAlumnosInteligenciasMultiples" runat="server">
                <ContentTemplate>
                    <div class="table-responsive">
                        <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosInteligenciasMultiples" CssClass="table table-bordered table-striped"
                            RowStyle-CssClass="td" HeaderStyle-CssClass="th" AllowPaging="True"
                            Width="100%" EnableSortingAndPagingCallbacks="True" AllowSorting="True" OnRowCommand="grdAlumnosInteligenciasMultiples_RowCommand"
                            OnSorting="grdAlumnosInteligenciasMultiples_Sorting" OnRowDataBound="grdAlumnosInteligenciasMultiples_DataBound" OnPageIndexChanging="grdAlumnosInteligenciasMultiples_PageIndexChanging">
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkCompletar" runat="server" CommandName="completar" CommandArgument='<%#Eval( "AlumnoID")%>'
                                            Width="25px" Height="25px" ImageUrl="~/Images/icons/VOCAREER_buscar.png" ToolTip="Completar prueba Hábitos"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
