<%@ Page Title="YOY - ORIENTADOR" Language="C#" MasterPageFile="~/PortalDocente/PortalDocente.master"
    AutoEventWireup="true" CodeBehind="Muro.aspx.cs" Inherits="POV.Web.PortalSocial.PortalDocente.Muro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head_selected" runat="server">
    ...
    <script src="<% =Page.ResolveClientUrl("~/Scripts/")%>core.publicaciones.docente.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#docente-tabs").tabs({
                create: function (event, ui) { page_dudas = 1; if (true) { $("#DudasStream").empty(); LoadDudas(); } }
            });
            var options = {
                'maxCharacterSize': 400,
                'originalStyle': 'pull-left', //display_info_textarea
                'warningStyle': 'display_warning_textarea',
                'warningNumber': 40,
                'displayFormat': '#left caracteres restantes de #max máx.'
            };
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_selected" runat="server">
    <div class="bodyadaptable">
        <div id="info_alumno">
            ...
            <h1 class="tBienvenida">Muro
            </h1>
        </div>
        <div>
            <div id="docente-tabs">
                <ul style="background-color: #f2f2f2;border: none;">
                    <li><a href="#docente-muro">Mis apuntes</a></li>
                    <li><a href="#docente-dudas">Preguntas de los estudiantes</a></li>
                </ul>
                <div id="docente-muro">
                    <!-- registrar publicacion -->
                    <div id="panel_insert_pub" class="ui-corner-all ui-widget-content">
                        <textarea id="txtPublicacion" rows="3" class="input_textarea" cols="30"></textarea>
                        <div class="pnl-insertar">
                            <div id="pnl-contenido-seleccionado-pub" class="pnl-contenido-agregado ui-state-highlight">
                                <input type="hidden" id="hdn-tipo-contenido-pub" />
                                <input type="hidden" id="hdn-identificador-contenido-pub" />
                                <label id="txt-nombre-contenido-pub">Mi archivo</label>
                                <button id="btn-delete-contenido" type="button" title="Quitar"
                                    style="float: right; margin-top: 3px;"
                                    onclick="myApiCompartir.quitarContenido('pub');">
                                    <span class="icon icon_trash" style="padding: 0px;"></span>
                                </button>
                            </div>
                        </div>
                        <div class="row">
                            <input type="button" value="Publicar" id="btnShare" class="btn-green pull-right" />
                        </div>
                    </div>
