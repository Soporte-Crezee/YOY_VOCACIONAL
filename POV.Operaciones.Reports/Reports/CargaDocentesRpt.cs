...
namespace POV.Operaciones.Reports.Reports
{
    public partial class CargaDocentesRpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private string tituloCargados;
        private string tituloNoCargados;
        ...
        public CargaDocentesRpt(Escuela escuela, CicloEscolar cicloEscolar, DataTable carga, DataTable resultados, string tituloReporte, string tituloCargados, string tituloNoCargados)
        {
            InitializeComponent();

            this.SetData(escuela, cicloEscolar, carga, resultados, tituloReporte, tituloCargados, tituloNoCargados);
        }

        public void SetData(Escuela escuela, CicloEscolar cicloEscolar, DataTable carga, DataTable resultados, string tituloReporte, string tituloCargados, string tituloNoCargados)
        {
            ...
            this.tituloCargados = tituloCargados;
            this.tituloNoCargados = tituloNoCargados;

            this.TituloReporte.Text = tituloReporte;
            this.TituloCargados.Text = tituloCargados;
            this.TituloNoCargados.Text = tituloNoCargados;
            ...
            Cargados.FindControl("cCorreo", true).DataBindings.Add("Text", registradas, "Correo");
            ...
            NoCargados.FindControl("cCorreoNA", true).DataBindings.Add("Text", noRegistradas, "Correo");
