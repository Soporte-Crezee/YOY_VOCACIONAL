...
namespace POV.Seguridad.Utils
{
    ...
    public class PasswordProvider
    {
        ...
        string caracteres = "abcdefghjkmnpqrstwxyz";
        ...
        /// </summary>
        public PasswordProvider(): this(8)
        { }
        ...
        public PasswordProvider(int longitudCaracteres)
            : this(longitudCaracteres, 0, 0, 20)
        { }
        ...
        /// <exception cref="ArgumentOutOfRangeException">Se produce al intentar introducir
        /// un porcentaje de caracteres especiales mayor de 100</exception>
        public PasswordProvider(int longitudCaracteres, int porcentajeMayusculas, int porcentajeSimbolos, int porcentajeNumeros)
        {
        ...
        public static string GetPassword()
        {
            ...
            PasswordProvider gp = new PasswordProvider();
