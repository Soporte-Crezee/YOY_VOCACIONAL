...
function confirmar() {
    ...
    if (bValid) {
        ...
        apiConfirmacion.ConfirmarInformacionDirector({ success: function (result) { onConfirmarDirectorComplete(result); } }, dataString);
    }
}

function onConfirmarDirectorComplete(data) {
