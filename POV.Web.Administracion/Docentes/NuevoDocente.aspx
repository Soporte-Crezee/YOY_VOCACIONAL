<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NuevoDocente.aspx.cs" Inherits="POV.Web.Administracion.Docentes.NuevoDocente" %>
    ...
    <script type="text/javascript">
        ...
        function validateDocente() {
            ...
            var rules = {
                ...
                <%=txtNombre.UniqueID %> :{required:false, maxlength:80},
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="bodyadaptable">
        <h1 class="tBienvenida">
            <asp:HyperLink runat="server" ID="lnkBack" NavigateUrl="~/Docentes/BuscarDocentes.aspx" CssClass="tBienvenidaLabel">
            Volver
            </asp:HyperLink>
            <%-- CG --%>
            ...
            <div class="row">
                ...
                <div class="col-md-12" style="padding: 20px 0px 0px 0px">
                    ...
                    <div class="col-xs-12 container_busqueda_general ui-widget-content">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 usuario1">
                                    <asp:TextBox runat="server" ID="txtNombreUsuario" TabIndex="8" MaxLength="50" CssClass="form-control" required="" data-required-error="Dato requerido" autocomplete="off"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                        ...
                        <div class="form-group" style="display: none;">
                            <asp:CheckBox ID="cbEsPremium" runat="server" Text="Es premium" TextAlign="Right" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-8 col-sm-7 col-md-7 col-xs-offset-3 col-sm-offset-5 col-md-offset-5">
                    <div class="opciones_formulario">
                        ...
                        <asp:HyperLink ID="HpLnkCancelar" Text="Cancelar" runat="server" NavigateUrl="BuscarDocentes.aspx"
                            CssClass="btn-cancel"></asp:HyperLink>
                    </div>
                </div>
            </div>
