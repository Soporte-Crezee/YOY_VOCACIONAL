<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditarUniversidad.aspx.cs" Inherits="POV.Web.Administracion.Universidades.EditarUniversidad" %>
    ...
    <script type="text/javascript">
        ...
        function validateUniversidad() {
            ...
            var rules = {                     
                ...
                <%=txtUsuario.UniqueID %>:{required:true,maxlength:50, minlength:6},
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="bodyadaptable">
        <h1 class="tBienvenida">
            <asp:HyperLink runat="server" ID="lnkBack" NavigateUrl="~/Universidades/BuscarUniversidad.aspx" CssClass="tBienvenidaLabel"> Volver </asp:HyperLink>
            / Editar escuela
        </h1>
        <%-- CG --%>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 email1">
                                    <asp:TextBox runat="server" ID="txtCorreo" TextMode="Email" TabIndex="5" MaxLength="100" CssClass="form-control" required="" data-required-error="Dato requerido"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7 usuario1">
                                    <asp:TextBox runat="server" ID="txtUsuario" TabIndex="7" MaxLength="50" CssClass="form-control" required="" data-required-error="Dato requerido"></asp:TextBox>
                                </div>
