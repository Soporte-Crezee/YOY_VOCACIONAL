...
namespace POV.Operaciones.Reports
{
    public partial class CargaAlumnosRpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void SetData(Escuela escuela, CicloEscolar cicloEscolar, DataTable carga, DataTable resultados)
        {
            ...
            this.GHGradoGrupo.GroupFields[0].FieldName = "GrupoGrado";
            this.GHGradoGrupo.GroupFields[0].SortOrder = XRColumnSortOrder.Ascending;
            this.GHGradoGrupo.GroupFields[1].FieldName = "GrupoNombre";
            this.GHGradoGrupo.GroupFields[1].SortOrder = XRColumnSortOrder.Ascending;

            cGrado.DataBindings.Add("Text", registradas, "GrupoGrado");
            cGrupo.DataBindings.Add("Text", registradas, "GrupoNombre");
            ...
            Cargados.FindControl("cTutor1", true).DataBindings.Add("Text", registradas, "NombreCompletoTutor");
            Cargados.FindControl("cTutor2", true).DataBindings.Add("Text", registradas, "NombreCompletoTutor2");

            //Docentes no cargados
            DataSet noRegistradas = this.FiltrarNoRegistrados();
            this.DNoCargados.DataSource = noRegistradas;

            this.GHGradoGrupoNA.GroupFields[0].FieldName = "GrupoGrado";
            this.GHGradoGrupoNA.GroupFields[0].SortOrder = XRColumnSortOrder.Ascending;
            this.GHGradoGrupoNA.GroupFields[1].FieldName = "GrupoNombre";
            this.GHGradoGrupoNA.GroupFields[1].SortOrder = XRColumnSortOrder.Ascending;

            cGradoNA.DataBindings.Add("Text", noRegistradas, "GrupoGrado");
            cGrupoNA.DataBindings.Add("Text", noRegistradas, "GrupoNombre");
            ...
            NoCargados.FindControl("cTutor1NA", true).DataBindings.Add("Text", noRegistradas, "NombreCompletoTutor");
            NoCargados.FindControl("cTutor2NA", true).DataBindings.Add("Text", noRegistradas, "NombreCompletoTutor2");
        }
