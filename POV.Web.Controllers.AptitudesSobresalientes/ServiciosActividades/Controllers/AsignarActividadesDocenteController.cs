...
{
    public class AsignarActividadesDocenteController
    {
        ...
        public AsignarActividadesDocenteController(Contexto contexto)
        {
            _sing = new object();
        ...
        /// <returns></returns>
        public List<ActividadDocente> ConsultarActividadesDocente(ActividadDocente criteriaActividad)
        {
            criteriaActividad.Activo = true;
            var ctrl = new ActividadDocenteCtrl(_model);
            var lstActividadesDocente = ctrl.Retrieve(criteriaActividad, false);
            ctrl.Dispose();
            return lstActividadesDocente;
        }
        ...
        public List<ActividadDocente> ConsultarTareasActividad(ActividadDocente criteriaActividad)
        {
            var ctrl = new ActividadDocenteCtrl(_model);
