...
{
    internal class PruebaAlumnosFrasesVocacionalesDARetHlp
    {
        /// <summary>
        /// Consulta registros de estudiantes que tienen reporte Frases Vocacionales en la base de datos.
        /// </summary>
        ...
        public DataSet Action(IDataContext dctx, Usuario usuario, APrueba prueba, String nombreCompletoAlumno = "") 
        {
            ...
            if (usuario == null)
                sError += ", Alumno";
            if (sError.Length > 0)
                throw new Exception("PruebaAlumnosFrasesVocacionalesDARetHlp: Los siguientes campos no pueden ser vacios " + sError.Substring(2));
            ...
            if (dctx == null)
                throw new StandardException(MessageType.Error, "", "DataContext no puede ser nulo", "POV.PruebaDiagnostico.DA",
                   "PruebaAlumnosFrasesVocacionalesDARetHlp", "Action", null, null);
            ...
            {
                throw new StandardException(MessageType.Error, "", "PruebaAlumnosFrasesVocacionalesDARetHlp: No se pudo conectar a la base de datos", "POV.PruebaDiagnostico.DA",
                    "PruebaAlumnosFrasesVocacionalesDARetHlp", "Action", null, null);
            }
            ...
            sCmd.Append("  inner join [SumarioGeneralFrasesVocacionales] sgs on sgs.AlumnoID = a.AlumnoID ");
            ...
            try
            {
                ...
                sqlAdapter.Fill(ds, "ResultadoPruebaFrasesVocacionales");
            }
            catch (Exception ex)
            {
                ...
                throw new Exception("PruebaAlumnosFrasesVocacionalesDARetHlp: Se encontraron problemas al recuperar los datos. " + exmsg);
            }
            finally
            {
                try { dctx.CloseConnection(myFirm); }
