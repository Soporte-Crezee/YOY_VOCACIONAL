<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaDominosTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaDominosTutorado" %>
        ...
        <div class="panel-body">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtNombre" runat="server" MaxLength="30" CssClass="form-control text-find" placeholder="Nombre del hijo"></asp:TextBox>
    ...
    <asp:UpdatePanel ID="updAlumnosDominos" runat="server">
        <ContentTemplate>
            <div class="table-responsive">
                <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosDominos" 
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="grdAlumnosDominos_RowCommand"
                    OnSorting="grdAlumnosDominos_Sorting" OnRowDataBound="grdAlumnosDominos_DataBound">
