<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaHabitosTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaHabitosTutorado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="page_content" runat="server">
    ...
    <asp:UpdatePanel ID="updAlumnosHabitos" runat="server">
        <ContentTemplate>
                ...
                <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosHabitos"
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="grdAlumnosHabitos_RowCommand"
                    OnRowDataBound="grdAlumnosHabitos_DataBound">
