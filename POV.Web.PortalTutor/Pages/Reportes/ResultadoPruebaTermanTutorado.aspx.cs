...
{
    public partial class ResultadoPruebaTermanTutorado : System.Web.UI.Page
    {
        ...
        public ResultadoPruebaTermanTutorado()
        {
                ...
                case "VerReporte":
                    {
                        try
                        {
                            Response.Redirect("ReporteAlumnoResultadoTerman.aspx?num=" + e.CommandArgument.ToString());
                        }
                        catch (Exception ex)
                        {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            LoadAlumnosTerman(new Tutor { TutorID = userSession.CurrentTutor.TutorID }, new PruebaDinamica { PruebaID = 11 }, "%" + txtNombre.Text.Trim() + "%");
        }

        private void LoadAlumnosTerman(Tutor tutor, APrueba prueba, String strNombre)
        {
            resultCtrl = new ResultadoPruebaDinamicaCtrl();
            grdAlumnosTerman.DataSource = resultCtrl.RetrieveAlumnosPruebas(ConnectionHlp.Default.Connection, tutor, prueba, strNombre);
