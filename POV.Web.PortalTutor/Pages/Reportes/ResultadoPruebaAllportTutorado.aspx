<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaAllportTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaAllportTutorado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="page_content" runat="server">
    ...
    <asp:UpdatePanel ID="updAlumnosAllport" runat="server">
        <ContentTemplate>
                ...
                <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosAllport"
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="grdAlumnosAllport_RowCommand"
                    OnSorting="grdAlumnosAllport_Sorting" OnRowDataBound="grdAlumnosAllport_DataBound">
