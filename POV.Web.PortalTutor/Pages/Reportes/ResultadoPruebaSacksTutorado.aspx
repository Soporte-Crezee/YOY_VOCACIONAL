<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaSacksTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaSacksTutorado" %>
        ...
        <ContentTemplate>
            <div class="table-responsive">
                <asp:GridView
                    ...
                    runat="server"
                    ID="gvResultadoPruebaSacksTutorado"                   
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="gvResultadoPruebaSacksTutorado_RowCommand"
                    OnRowDataBound="gvResultadoPruebaSacksTutorado_RowDataBound">
