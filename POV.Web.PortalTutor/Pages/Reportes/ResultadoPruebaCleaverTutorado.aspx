<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaCleaverTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaCleaverTutorado" %>
        ...
        <ContentTemplate>
            <div class="table-responsive">
                <asp:GridView
                    ...
                    runat="server"
                    ID="gvResultadoPruebaCleaverTutorado"
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="gvResultadoPruebaCleaverTutorado_RowCommand"
                    OnRowDataBound="gvResultadoPruebaCleaverTutorado_RowDataBound">
