<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaChasideTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaChasideTutorado" %>
        ...
        <ContentTemplate>
            <div class="table-responsive">
                <asp:GridView
                    ...
                    runat="server"
                    ID="gvResultadoPruebaChasideTutorado"
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="gvResultadoPruebaChasideTutorado_RowCommand"
                    OnRowDataBound="gvResultadoPruebaChasideTutorado_RowDataBound">
