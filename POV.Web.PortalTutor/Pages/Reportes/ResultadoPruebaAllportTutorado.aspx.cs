...
{
    public partial class ResultadoPruebaAllportTutorado : System.Web.UI.Page
    {
        ...
        public ResultadoPruebaAllportTutorado()
        {
                ...
                case "VerReporte":
                    {
                        try
                        {
                            Response.Redirect("ReporteAlumnoResultadoAllport.aspx?num=" + e.CommandArgument.ToString());
                        }
                        catch (Exception ex)
                        {
        ...
        {
            LoadAlumnosAllport(new Tutor { TutorID = userSession.CurrentTutor.TutorID }, new PruebaDinamica { PruebaID = 15 }, "%" + txtNombre.Text.Trim() + "%");

        }

        private void LoadAlumnosAllport(Tutor tutor, APrueba prueba, String strNombre)
        {
            resultCtrl = new ResultadoPruebaDinamicaCtrl();
            grdAlumnosAllport.DataSource = resultCtrl.RetrieveAlumnosPruebas(ConnectionHlp.Default.Connection, tutor, prueba, strNombre);
