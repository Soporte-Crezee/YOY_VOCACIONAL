<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResultadoPruebaRavenTutorado.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.Reportes.ResultadoPruebaRavenTutorado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="page_content" runat="server">
    ...
    <asp:UpdatePanel ID="updAlumnosAllport" runat="server">
        <ContentTemplate>
                ...
                <asp:GridView AutoGenerateColumns="false" runat="server" ID="grdAlumnosRaven"
                    RowStyle-CssClass="td"
                    HeaderStyle-CssClass="th"
                    CssClass="table table-bordered table-striped"
                    OnRowCommand="grdAlumnosRaven_RowCommand"
                    OnSorting="grdAlumnosRaven_Sorting" OnRowDataBound="grdAlumnosRaven_DataBound">
