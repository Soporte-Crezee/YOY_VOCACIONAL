...
{
    public partial class ResultadoPruebaDominosTutorado : System.Web.UI.Page
    {
        ...
        public ResultadoPruebaDominosTutorado()
        {
                ...
                case "VerReporte":
                    {
                        try
                        {
                            Response.Redirect("ReporteAlumnoResultadoDominos.aspx?num=" + e.CommandArgument.ToString());
                        }
                        catch (Exception ex)
                        {
        ...
        {
            LoadAlumnosDominos(new Tutor { TutorID = userSession.CurrentTutor.TutorID }, new PruebaDinamica { PruebaID = 10 }, "%" + txtNombre.Text.Trim() + "%");
        }

        private void LoadAlumnosDominos(Tutor tutor, APrueba prueba, String strNombre)
        {
            resultCtrl = new ResultadoPruebaDinamicaCtrl();
            grdAlumnosDominos.DataSource = resultCtrl.RetrieveAlumnosPruebas(ConnectionHlp.Default.Connection, tutor, prueba, strNombre);
