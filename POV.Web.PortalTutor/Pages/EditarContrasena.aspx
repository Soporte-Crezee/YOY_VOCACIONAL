<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarContrasena.aspx.cs" Inherits="POV.Web.PortalTutor.Pages.EditarContrasena" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="page_content" runat="server">
    <asp:Label ID="LblNombreUsuario" runat="server" Text="" CssClass="tBienvenidaLabel-usuario" Style="display:none;"></asp:Label>
    <ul class="breadcrumb">
        <li>Cambio de contrase&ntilde;a</li>
    </ul>
