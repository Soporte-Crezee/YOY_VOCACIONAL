...
{
    public partial class DetalleExpedienteAlumnoTutor : System.Web.UI.Page
    {
        ...
        public DetalleExpedienteAlumnoTutor()
        {
        ...
        /{
            ...
            {
                case "lnkBtnInfoPersonal":
                    mtvDatos.SetActiveView(viewInfoPersonal);
                    hdnTabSeleccionado.Value = "td-infoPersonal";
                    break;
                case "lnkBtnHistServicios":
                    mtvDatos.SetActiveView(viewHistServicios);
                    hdnTabSeleccionado.Value = "td-HistServ";
                    break;
            }
        }*/
        #endregion
        ...
        private void CargarDatos()
        {
            ...
            grupoCicloEscolar.CicloEscolar = userSession.CurrentCicloEscolar;
            ...
            #region Docentes Asignados
            Docente docente = new Docente();
            OrientadorUniversidad orientador;
            List<OrientadorUniversidad> listOrientador = new List<OrientadorUniversidad>();
            ...
            grdOrientadores.DataSource = listOrientador;
            ...
            if (respuestaAlumno.Count > 0)
            {
                foreach (var prueba in respuestaAlumno)
                {
                    ...
                    if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.HabitosEstudio)
                    {
                        ...
                        lbResultadoGratis1.InnerText = spaces + prueba.Nombre;
                    ...
                    if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.Dominos)
                    {
                        ...
                        string spaces = Server.HtmlDecode("&nbsp;&nbsp;&nbsp;&nbsp;");
                        lbResultadoPremium1.InnerText = spaces + prueba.Nombre;
                    ...
                    if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.Rotter) 
                    {
                        ...
                        divTablaResultadoRotter.Visible = true;
                    ...
                    if (prueba.TipoPruebaPresentacion == (byte)ETipoPruebaPresentacion.FrasesIncompletasVocacionales)
                    {
                        ...
                        {
                            string spaces = Server.HtmlDecode("&nbsp;&nbsp;&nbsp;&nbsp;");
                            lblResultadoFrasesVocacionales.InnerText = spaces + prueba.Nombre;
                            divTablaResultadosFrasesVocacionales.Visible = true;
        ...
        {
            string backColor = "padding: 5px 0 5px 8px;margin: 0;border: 1px solid #ccc;color: #aaa;width: 14%;height: auto;width: 180px;";

            //Style tabla dresultados dominos
        ...
        private void VistaResultadoTerman(DataSet series)
        {
            ...
            #region Serie X
            if (serieDiez >= 19)
                lblRango10Terman.Text = "Sobresaliente";
            if (serieDiez == 18)
                lblRango10Terman.Text = "Superior";
            if (serieDiez == 16 || serieDiez == 17)
                lblRango10Terman.Text = "Térm. M. A";
            if (serieDiez >= 9 && serieDiez <= 15)
                lblRango10Terman.Text = "Térm. Medio";
            if (serieDiez == 8)
                lblRango10Terman.Text = "Térm. M. B.";
            if (serieDiez == 6 || serieDiez == 7)
                lblRango10Terman.Text = "Inferior";
            if (serieDiez <= 5)
                lblRango10Terman.Text = "Deficiente";
            #endregion
            #endregion
        ...
        private void VistaResultadoFrasesVocacionales(SumarioGeneralFrasesVocacionales sumarioGeneralFrasesVocacionales)
        {
            ...
            {
                lblOrganizacion.Text = sumarioGeneralFrasesVocacionales.SumarioOrganizacionPersonalidad;
                lblPerspectiva.Text = sumarioGeneralFrasesVocacionales.SumarioPerspectivaOpciones;
                lblFuentes.Text = sumarioGeneralFrasesVocacionales.SumarioFuentesConflicto;
            }
        }
