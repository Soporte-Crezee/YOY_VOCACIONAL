<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarPassword.aspx.cs" Inherits="POV.Web.PortalTutor.Auth.RecuperarPassword" %>
...
<head id="Head1" runat="server">
    ...
    <link href="~/Styles/Login-responsive.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-group" id="paso2Correo" style="display: none">
                                ...
                                <asp:TextBox ID="txtCorreo" runat="server" MaxLength="100" CssClass="form-control" TextMode="Email"></asp:TextBox>
